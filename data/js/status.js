var status_data = `<div style="width: 100%; background-color: rgba(140, 0, 0, 0.69); text-align: center; margin: auto; padding: 6vh 2vw; max-width: 100%; box-sizing: border-box; color: white">
            ...
            <br>
            <!-- Status message -->
            <span style="text-shadow: white 0 0 4px; color: white; font-size: 24px;">Yuri's Night is this Friday! Join us at 7 PM in Appel 303 for our annual lecture, presented this year by Professor Mason Peck. See the <a href="/events/lectures/">Lecture Series page</a> for more information.</span>
        </div>`
