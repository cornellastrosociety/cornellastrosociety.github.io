var status_data = `<div style="width: 100%; background-color: rgba(140, 0, 0, 0.69); text-align: center; margin: auto; padding: 6vh 2vw; max-width: 100%; box-sizing: border-box; color: white">
            ...
            <br>
            <!-- Status message -->
            <span style="text-shadow: white 0 0 4px; color: white; font-size: 24px;">We'll be hosting a special open house night throughout the night of March 13th, beginning at 10 PM, to observe the total lunar eclipse! See <a href="/#eventinfo">the home page</a> for more details.</span>
        </div>`
