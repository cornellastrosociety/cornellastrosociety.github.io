var status_data = `<div style="width: 100%; background-color: rgba(140, 0, 0, 0.69); text-align: center; margin: auto; padding: 6vh 2vw; max-width: 100%; box-sizing: border-box; color: white">
            ...
            <br>
            <!-- Status message -->
            <span style="text-shadow: white 0 0 4px; color: white; font-size: 24px; line-height: 1.5em;">The last open house of the year will be held on Friday, December 19th. We will be closed for Winter Break, and reopen on Friday, January 16th.</span>
        </div>`
